...
/* iCDS Android FFI spike: take va_list by pointer so the FALSE-formatted
 * call sites can legally pass NULL. NDK clang rejects implicit void* → va_list
 * conversion as a hard error; Apple clang historically allowed it. */
