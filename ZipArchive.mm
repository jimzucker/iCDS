...
//		28 Dec JAZ - added encoding to stringWithCString to clear warning of depricated method
//
...
-(BOOL) UnzipFileTo:(NSString*) path overWrite:(BOOL) overwrite
{
	...
	do{
		...
		NSString * strPath = [NSString  stringWithCString:filename encoding:NSUTF8StringEncoding];   //jaz 28Dec - added Encoding to clear warning
		BOOL isDirectory = NO;
